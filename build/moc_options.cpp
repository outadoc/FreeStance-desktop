...
**
** Created: Tue Mar 8 00:31:20 2011
...
static const char qt_meta_stringdata_Options[] = {
    "Options\0\0profile\0"
    "on_cbox_profil_currentIndexChanged(int)\0"
...
int Options::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_cbox_profil_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: on_cbox_hd_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: on_txtfield_code_textEdited(); break;
        case 3: on_b_ok_clicked(); break;
        case 4: on_b_cancel_clicked(); break;
        default: ;
        }
        _id -= 5;
    }
